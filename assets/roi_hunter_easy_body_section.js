...
(function() {
    ...
    if (facebookRemarketingActive) { // if customer has active facebook
        ...
        ourAmazingGlobalObject.rheasy_fbq('492640928196717', 'PageView');

        if (ourAmazingGlobalObject.cartPage.active) {
            ourAmazingGlobalObject.rheasy_fbq('492640928196717', 'AddToCart', ourAmazingGlobalObject.cartPage.facebookEventParams);
        } else if (ourAmazingGlobalObject.productPage.active) {
            ourAmazingGlobalObject.rheasy_fbq('492640928196717', 'ViewContent', ourAmazingGlobalObject.productPage.facebookEventParams);
        }
    }
