...
Last updated: 2019-09-13 18:09:38 UTC
*****************/



window.__CONSISTENT_CART_SETTINGS = {
	'last_updated':"2019-09-13 18:09:38 UTC",
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var o=t[r];o.enumerable=o.enumerable||!1,o.configurable=!0,"value"in o&&(o.writable=!0),Object.defineProperty(e,o.key,o)}}return function(t,r,o){return r&&e(t.prototype,r),o&&e(t,o),t}}(),_jquery=require("jquery"),_jquery2=_interopRequireDefault(_jquery),_utilityStorage=require("../utility/storage"),_utilityStorage2=_interopRequireDefault(_utilityStorage),_utilityConstants=require("../utility/constants"),_utilityConstants2=_interopRequireDefault(_utilityConstants),_external_app_integrations=require("./external_app_integrations"),_external_app_integrations2=_interopRequireDefault(_external_app_integrations),_utilityLogger=require("../utility/logger"),_utilityLogger2=_interopRequireDefault(_utilityLogger),storage=new _utilityStorage2.default,constants=new _utilityConstants2.default,logger=new _utilityLogger2.default("FacebookAtcWidget"),FacebookAtcWidget=function(){function t(e){return void _classCallCheck(this,t)}return _createClass(t,[{key:"findAddToCartButton",value:function(e,t,r){var o=window.__CONSISTENT_CART_SETTINGS.facebook.facebook_button_selector,a=void 0,n=[(0,_jquery2.default)("#AddToCart"),(0,_jquery2.default)("input#addToCart"),(0,_jquery2.default)("button#addToCart"),(0,_jquery2.default)("button.product-form__cart-submit"),(0,_jquery2.default)("button#addToCart-product-template"),(0,_jquery2.default)("button#AddToCart-product-template"),(0,_jquery2.default)('input[type="submit"]#product-add-to-cart'),(0,_jquery2.default)("button#product-form__cart-submit"),(0,_jquery2.default)('.product-add input[type="submit"][value="Add to Cart"]'),(0,_jquery2.default)(".product-single__add-to-cart button#AddToCart--product-template"),(0,_jquery2.default)('button[type="submit"].buy_now')];if(o&&o.length){n.push((0,_jquery2.default)(o)),this.attachMutationObserver();var i=this;(0,_jquery2.default)("body").observe(o,function(a){i.bindAtcButton((0,_jquery2.default)(o),e,t,r)})}return"java-bean-plus.myshopify.com"==Shopify.shop&&n.push((0,_jquery2.default)('button[type="submit"][value="Checkout"].bold_clone')),"cheekythr.myshopify.com"==Shopify.shop&&n.push((0,_jquery2.default)('button[type="submit"].action_button.add_to_cart')),"ridegenesis.myshopify.com"==Shopify.shop&&n.push((0,_jquery2.default)('button[type="submit"].product_add_to_cart_btn')),_jquery2.default.each(n,function(e,t){t.length&&(a=t)}),(window.location.href.indexOf("ccFb")>0||storage.get("ccFb"))&&a&&a.css({"border-bottom":"5px solid yellow"}),a}},{key:"bindAtcButton",value:function(e,t,r,o){e&&e.click(function(a){if("checked"===window.ccLastFacebookEvent&&!window.cclotsOfStuffAlreadyDone){var n=window.__CONSISTENT_CART_SETTINGS.facebook.ajax_form_override;a.preventDefault(),n&&e.closest("form").on("submit",function(e){e.preventDefault()}),storage.set("fbMessengerAlreadyAgreed",!0),storage.set("fbMessengerAlreadyAgreedUserRef",t),(0,_jquery2.default)(".fb-messenger-checkbox").hide(),(0,_jquery2.default)(".cc-recv-notification-updates").hide(),FB.AppEvents.logEvent("MessengerCheckboxUserConfirmation",null,{app_id:""+r,page_id:""+o,ref:"none",user_ref:""+t});var i={cart_token:storage.get("uuid"),email:storage.get("email"),cc_token:storage.get("cc_token"),shopify_domain:Shopify.shop,app_id:""+r,page_id:""+o,ref:"none",user_ref:""+t},u=constants.api_server+"/static/facebook_register_user_message_auth";_jquery2.default.post(u,i,function(){window.cclotsOfStuffAlreadyDone=!0,n?e.closest("form").trigger("submit"):e.click()})}})}},{key:"bindDiscountBtn",value:function(e,t,r,o){var a=this;e&&e.click(function(n){if(n.preventDefault(),"checked"!==window.ccLastFacebookEvent)return(0,_jquery2.default)(".fb-messenger-checkbox").addClass("shake-animation"),void setTimeout(function(){(0,_jquery2.default)(".fb-messenger-checkbox").removeClass("shake-animation")},1e3);if(!e.hasClass("discount-widget-btn-after")){e.addClass("discount-widget-btn-after").removeClass("discount-widget-btn").text(a.options.fb_atc_widget_discount_after_btn_click_text),storage.set("fbMessengerAlreadyAgreed",!0),storage.set("fbMessengerAlreadyAgreedUserRef",t),FB.AppEvents.logEvent("MessengerCheckboxUserConfirmation",null,{app_id:r,page_id:o,ref:"none",user_ref:t});var i={cart_token:storage.get("uuid"),email:storage.get("email"),cc_token:storage.get("cc_token"),shopify_domain:Shopify.shop,app_id:""+r,page_id:""+o,ref:"none",user_ref:""+t},u=constants.api_server+"/static/facebook_register_user_message_auth";_jquery2.default.post(u,i,function(){}),(0,_jquery2.default)("#widget_cc_container").hide(),(0,_jquery2.default)(".fb-messenger-checkbox").hide(),(0,_jquery2.default)(".cc-recv-notification-updates").hide()}})}},{key:"fb_checkbox_settings",value:function(){return window.__CONSISTENT_CART_SETTINGS.facebook}},{key:"placeTheElement",value:function(e){var t=this.fb_checkbox_settings(),r=this.parseTheElementString();if((0,_jquery2.default)("head").append(_jquery2.default.parseHTML("\n      <style>\n        .fb-messenger-checkbox{\n          width: 200px;\n        }\n      </style>\n    ",document,!0)),(0,_jquery2.default)(".cc-facebook-messenger-placeholder").length>0)return(0,_jquery2.default)(".cc-facebook-messenger-placeholder")[0].style.cssText||(0,_jquery2.default)(".cc-facebook-messenger-placeholder").css({"text-align":"center"}),void(0,_jquery2.default)(".cc-facebook-messenger-placeholder").html(_jquery2.default.parseHTML(e));if(r){var o=_jquery2.default.parseHTML("<div class='cc-fb-checkbox-placeholder'></div>");"after"==t.fb_append?(0,_jquery2.default)(r).append(o):(0,_jquery2.default)(r).prepend(o),(0,_jquery2.default)(".cc-fb-checkbox-placeholder").append(_jquery2.default.parseHTML(e)),t.fb_placer_element&&t.fb_placer_element.length>0&&(0,_jquery2.default)(".cc-fb-checkbox-placeholder").css({display:t.fb_display,"margin-top":t.fb_margin_top,"margin-right":t.fb_margin_right,"margin-bottom":t.fb_margin_bottom,"margin-left":t.fb_margin_left}),"fill"===t.fb_width&&(0,_jquery2.default)(".cc-fb-checkbox-placeholder").css({width:"100%"})}}},{key:"parseTheElementString",value:function(){var e=window.__CONSISTENT_CART_SETTINGS.facebook.fb_placer_element;if(e){e=e.replace(" hint-mode_show-block",""),e=e.replace("hint-mode_show-block",""),e=e.replace("#undefined",""),e.endsWith(".")&&(e=e.substring(0,e.length-1));for(var t=e.split(" "),r=0;r<t.length;r++){var o=t[r];o.startsWith("#")||o.startsWith(".")||(o="."+o,t[r]=o)}return e=t.join("")}}},{key:"heartbeat",value:function(){if(!document.hidden){var e={cc_token:storage.get("cc_token"),shopify_domain:Shopify.shop},t=constants.micro_server+"/facebook_heartbeat";_jquery2.default.post(t,e)}}},{key:"attachMutationObserver",value:function(){try{!function(e){var t=window.MutationObserver||window.WebKitMutationObserver||window.MozMutationObserver,r=function(r,o,a,n){function i(t,r){Array.prototype.slice.call(t).forEach(function(t){s&&u.target[0]!==e(t).parent()[0]||(e(t).is(c)&&r.call(t),s||e(o,t).each(function(){r.call(this)}))})}var u=this;this.target=r;var s=">"===o[0],c=s?o.substr(1):o;this.observer=new t(function(e){u.disconnect(),e.forEach(function(e){a&&i(e.addedNodes,a),n&&i(e.removedNodes,n)}),u.observe()}),e(o,r).each(function(){a.call(this)}),this.observe()};r.prototype.disconnect=function(){this.observer.disconnect()},r.prototype.observe=function(){this.observer.observe(this.target[0],{childList:!0,subtree:!0})},e.fn.observe=function(e,t,o){if(this.length){var a=this.data("contracts");a||(a=[]);var n=a.filter(function(t){return t.selector===e});if(n.length)return n[0].onAdded=t,void(n[0].onRemoved=o);var i=new r(this,e,t,o);return a.push(i),this.data("contracts",a),this}}}(_jquery2.default)}catch(r){var t=new _utilityLogger2.default("errors");throw t.logError(e),r}}}]),t}();exports.default=FacebookAtcWidget,module.exports=exports.default;
